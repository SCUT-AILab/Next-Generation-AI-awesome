...
- **Groundbreaking Work: Transformer**.
  ...
  - **Blog: xxx**
  - **Paper**: *Attention Is All You Need* [[PDF](https://proceedings.neurips.cc/paper_files/paper/2017/file/3f5ee243547dee91fbd053c1c4a845aa-Paper.pdf)]
...
- **Evolution with Pretraining and Finetuning: BERT**.
  ...
  - **Blog: xxx**
  - **Paper**: *BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding* [[PDF](https://arxiv.org/pdf/1810.04805.pdf)]
...
- **Zero-shot Predictions with Pretraining at Scales: GPT families**.
  ...
  - **Paper**: GPT-1, 2, and 3 have been accompanied by academic publications, while GPT-4 is currently only documented in a technical report without any model or training details.
    - *Improving Language Understanding by Generative Pre-Training (GPT-1)* [[PDF](https://cdn.openai.com/research-covers/language-unsupervised/language_understanding_paper.pdf)]
    - *Language Models are Unsupervised Multitask Learners (GPT-2)* [[PDF](https://cdn.openai.com/better-language-models/language_models_are_unsupervised_multitask_learners.pdf)]
    - *Language Models are Few-Shot Learners (GPT-3)* [[PDF](https://proceedings.neurips.cc/paper/2020/file/1457c0d6bfcb4967418bfb8ac142f64a-Paper.pdf)]
...
- **Learning with Human Feedbacks: Instruct-GPT & ChatGPT**.
  ...
  - **Blog: xxx**
  - **Paper**: *InstructGPT: Training Language Models to Follow Instructions With Human Feedback* [[PDF](https://proceedings.neurips.cc/paper_files/paper/2022/file/b1efde53be364a73914f58805a001731-Paper-Conference.pdf)]
